...
issues:
  ...
  - number: "003"
    ...
    thesis: >
      GNU fragility and the insurance sector's mispriced political exposure —
  ...
  - number: "002"
    ...
    title: "Issue 002"
    thesis: >
      Previous issue — see archive.
    href: "issue-002.html"
    is_latest: false

  - number: "001"
    date: "May 2026"
    title: "The Cities That Insurance Cannot Hold"
    thesis: >
      Municipal infrastructure collapse has crossed an actuarial threshold —
      and the reinsurance market is moving before the primary market does.
    href: "issue-001.html"
    is_latest: false
...
The publication is read by C-suite executives, senior underwriters, risk officers, FSCA
and PA officials, institutional investors, and senior brokers. It assumes deep domain
knowledge and delivers in return the one thing premium readers cannot get from any other
source: non-obvious insight with the intellectual courage to say it directly.
...
Classify systems as fragile, robust, or antifragile. Prioritise the shape of distributions
over their means. Identify who has skin in the game and who is transferring fragility to
others. The Fragility Index and Black Swan Watch exist because of this framework.
...
from linear-seeming inputs. Second-order effects are not optional analysis — they are the
core of AFI's predictive value.

### Kahneman — Behavioral Economics
Policyholders, brokers, and underwriters do not behave as rational agents. Identify the
specific biases — loss aversion, present bias, herding, availability bias —
producing the mispricings, fragilities, and hidden profit pools that AFI exists to surface.
